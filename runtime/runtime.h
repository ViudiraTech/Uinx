...
int32_t uinx_hashmap_get(const uinx_hashmap_raw* map,
                         const void* key,
                         size_t key_len,
                         uintptr_t* out_value);
int32_t
uinx_hashmap_remove(uinx_hashmap_raw* map, const void* key, size_t key_len, uintptr_t* out_value);
