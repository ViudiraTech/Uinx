...
enum class SymbolKind { Function, Struct, Trait, Local, Parameter, Field, Generic };
struct Symbol {
    SymbolId id{};
    SymbolKind kind{};
    std::string name;
