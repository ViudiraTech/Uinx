...
Token Lexer::identifier_or_keyword() {
    ...
    static const std::unordered_map<std::string, TokenKind> keywords = {
        ...
        {"Self", TokenKind::KwSelfTy},
        {"dyn", TokenKind::KwDyn},
        {"asm", TokenKind::KwAsm},
        {"ref", TokenKind::KwRef},
        {"mutref", TokenKind::KwMutRef},
        {"ptr", TokenKind::KwPtr},
        {"mutptr", TokenKind::KwMutPtr},
        ...
        {"compiler_fence", TokenKind::KwCompilerFence},
    };
